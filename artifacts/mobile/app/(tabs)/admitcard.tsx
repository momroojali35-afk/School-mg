  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  <div style="background:linear-gradient(135deg,#1e3a8a 0%,#2563EB 100%);padding:18px 24px;display:flex;align-items:center;gap:16px">
    ...
    <div style="flex:1">
      ...
      <div style="color:rgba(255,255,255,0.82);font-size:11px;margin-top:3px">${SCHOOL_INFO.address} | Ph: ${SCHOOL_INFO.contact} | ${SCHOOL_INFO.email}</div>
    </div>
  ...
  <div style="background:linear-gradient(135deg,#6d28d9 0%,#2563EB 60%,#06B6D4 100%);padding:20px 24px;position:relative;overflow:hidden">
    ...
    <div style="display:flex;align-items:center;gap:16px;position:relative">
      ...
      <div style="flex:1">
        ...
        <div style="color:rgba(255,255,255,0.75);font-size:11px;margin-top:2px">${SCHOOL_INFO.address} • ${SCHOOL_INFO.contact}</div>
      </div>
    ...
    <div style="border:1.5px solid rgba(245,158,11,0.4);border-radius:10px;padding:18px;position:relative">
      <div style="display:flex;align-items:center;gap:18px">
        ...
        <div style="flex:1">
          ...
          <div style="color:rgba(255,255,255,0.6);font-size:11px;margin-top:3px;font-family:Arial">${SCHOOL_INFO.address} | ${SCHOOL_INFO.contact}</div>
        </div>
  ...
  <header style="background:#102C55;color:#fff;padding:28px 40px 24px;position:relative">
    ...
    <div style="display:flex;align-items:center;gap:18px;position:relative">
      ...
      <div style="flex:1">
        ...
        <div style="font-size:10.5px;color:#C8D4E4;margin-top:6px">${SCHOOL_INFO.address} · ${SCHOOL_INFO.contact} · ${SCHOOL_INFO.email}</div>
      </div>
    </div>
            ...
            <View style={pm.card}>
              ...
              <View style={[pm.cardHeader, { backgroundColor: '#102C55' }]}>
                ...
                <View style={{ flex: 1, marginLeft: 12 }}>
                  ...
                  <Text style={pm.schoolAddr}>{SCHOOL_INFO.address} • {SCHOOL_INFO.contact} • {SCHOOL_INFO.email}</Text>
                </View>
