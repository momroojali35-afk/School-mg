        ...
        <View style={[styles.sheet, { backgroundColor: colors.background }]}>
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              <Text
                style={[styles.className, { color: colors.mutedForeground }]}
              >
                {studentClass}
              </Text>
            </View>
          ...
          >
            <View style={styles.statsRow}>
              ...
              <View
                style={[styles.statBox, { backgroundColor: pctColor + "15" }]}
              >
                <Text style={[styles.statValue, { color: pctColor }]}>
                  {attendancePct}%
                </Text>
                <Text style={[styles.statLabel, { color: pctColor }]}>
                  Attendance
                </Text>
              </View>
              <View
            ...
            {months.length === 0 ? (
              ...
              months.map((month) => {
                ...
                const monthAttendanceDays =
                  present.length + absent.length + inactive.length;
                const monthPct =
                  monthAttendanceDays > 0
                ...
                return (
                  ...
                  >
                    ...
                    {holiday.length > 0 && (
                      <View style={styles.dateSection}>
                        <Text
                          style={[styles.dateTitle, { color: colors.warning }]}
                        >
                          <Feather
                            name="sun"
                            size={11}
