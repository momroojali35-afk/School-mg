      ...
      <div className="scrim">
        <div className="premium-sheet">
          <div className="premium-top">
            ...
            <p>Your student records are up to date</p>
          </div>
          <div className="premium-body">
            <div className="promotion-summary">
              <div className="summary-icon">↗</div>
              <div className="summary-copy"><strong>2 students promoted</strong>Moved successfully to Class 5</div>
            </div>
            <button className="premium-action">Continue</button>
            <button className="premium-dismiss">View promotion history</button>
          </div>
        </div>
      </div>
    </main>
