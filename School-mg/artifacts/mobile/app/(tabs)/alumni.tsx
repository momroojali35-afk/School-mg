...
const styles = StyleSheet.create({
  ...
  filterBar: { flexGrow: 0, flexShrink: 0, height: 48, borderBottomWidth: StyleSheet.hairlineWidth },
  filterContent: { alignItems: 'center', gap: 8, height: 48, paddingHorizontal: 12 },
  filter: { flexGrow: 0, flexShrink: 0, alignItems: 'center', justifyContent: 'center', minHeight: 30, borderRadius: 18, paddingHorizontal: 13, paddingVertical: 7 },
